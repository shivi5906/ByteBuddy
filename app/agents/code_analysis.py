...
class MultiLanguageCodeAnalyzer:
    ...
    def suggest_code_refactoring(self, code: str ) -> str:
        ...
        analyse the code given to you and the code maybe in any language just take an idea by analysing the syntax of the functions used and the
                                              mehtods that are used .
...
3. **Performance**: {'Consider optimizing nested loops' if nested_loops >= 2 else 'Performance looks acceptable'}
...
""")
    ...
    def suggest_improvements(self, code: str) -> str:
        ...
        prompt = PromptTemplate.from_template("""
Analyze this code and provide specific, actionable improvement suggestions:
...
4. **Security Considerations**: Potential security issues
5. **Error Handling**: How to make it more robust
6. **Best Practices**: Industry standard practices
